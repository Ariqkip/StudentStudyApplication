package dev.ariq.niceapp.general
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSubmit.setOnClickListener {
            if(editFeedback.text.toString().isEmpty()){
                ...
                myRef.push().setValue(FeedbackData(AppPreferences.studentName,
                    AppPreferences.studentEmailID,editFeedback.text.toString().trim()))
